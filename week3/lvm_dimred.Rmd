...
ggplot(tsne_out) + geom_point(aes(x=V1, y=V2, col=as.factor(km_clustered$cluster))) + labs(title="Scatter plot of t-SNE projection of genes clustered using K-means", col="K-means clusters") # coloring using the k-means clusters
